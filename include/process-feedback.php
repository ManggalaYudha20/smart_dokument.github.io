<?php 
// ====================================================
// PENGKONDISIAN SEND FEEDBACK USER
// ====================================================
// SEND DATA FEEDBACK USER
if (isset($_POST["send_feedback"])) {
	if (sendFeedback($_POST) > 0) {
		echo "
    <script>
      alert('Terimakasih sudah memberikan Feedback kepada kami. Feedbackmu sudah kami terima');
