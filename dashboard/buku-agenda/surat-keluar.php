...
if (!empty($_GET["dari"]) || !empty($_GET["ke"])) {
	// query table surat keluar berdasarkan dari tgl berapa sampai tgl berapa
	$querySuratKeluar = query("SELECT * FROM tb_surat_keluar WHERE tgl_diterima BETWEEN '" . $_GET['dari'] . "' and '" . $_GET['ke'] . "'");
}
...
<head>
	...
	<title>Agenda Surat Keluar - smart dokument</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Agenda Surat Keluar</h4>
							...
							<div class="card">
								...
								<?php if (isset($_GET["filter"])) : ?>
									<div class="row card-body">
										<div class="col-md-12">
											<h3>
												Agenda Surat Keluar dari tanggal <strong><?= tgl_indo(date($_GET["dari"])); ?></strong> sampai dengan tanggal <strong><?= tgl_indo(date($_GET["ke"])); ?></strong>

												<?php if (!empty($querySuratKeluar)) : ?>
													<a href="print-surat-keluar?dari=<?= $_GET["dari"]; ?>&ke=<?= $_GET["ke"]; ?>&filer=" class="btn btn-warning"><i class="fa fa-print"></i> CETAK</a>
												<?php endif; ?>
