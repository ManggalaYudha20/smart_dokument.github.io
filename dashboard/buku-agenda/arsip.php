...
$queryArsip = query("SELECT * FROM tb_arsip WHERE ket_nasib_akhir = 'Permanen' and 'Dinilai Kembali' and 'Usul Musnah' ");

// Filter tabel arsip berdasarkan keterangan nasib akhir
if (isset($_GET["filter"])) {
	$queryArsip = filterArsip($_GET["ket_nasib_akhir"]);
}
...
<head>
	...
	<title>Agenda Arsip Dokumen - smart dokument</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Agenda Arsip Dokumen</h4>
							...
							<div class="card">
											...
											<div class="ml-auto filter-agenda">
												<form action="" method="get">
													<table>
														<tr>
															<td>
																<label for="ket_nasib_akhir">Ket. Nasib Akhir</label>
															</td>
															<td>
																<select name="ket_nasib_akhir" id="ket_nasib_akhir" class="form-control" id="exampleFirstName" required oninvalid="this.setCustomValidity('Keterangan nasib akhir harus diisi!')" oninput="setCustomValidity('')" placeholder=" " autocomplete="off">
								...
								<?php if (isset($_GET["filter"])) : ?>
									<div class="row card-body">
										<div class="col-md-12">
											<h3>
												Agenda arsip dokumen dengan keterangan nasib akhir
												<strong><?= $_GET["ket_nasib_akhir"]; ?></strong>

												<?php if (!empty($queryArsip)) : ?>
													<a href="print-arsip?ket_nasib_akhir=<?= $_GET["ket_nasib_akhir"]; ?>&filter=" class="btn btn-warning"><i class="fa fa-print"></i> CETAK</a>
												<?php endif; ?>
