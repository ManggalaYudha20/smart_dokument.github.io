...
if (!empty($_GET["dari"]) || !empty($_GET["ke"])) {
	...
	$querySuratMasuk = query("SELECT * FROM tb_surat_masuk WHERE tgl_diterima BETWEEN '" . $_GET['dari'] . "' and '" . $_GET['ke'] . "'");
}
...
<head>
	...
	<title>Agenda Surat Masuk - smart dokument</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Agenda Surat Masuk</h4>
							...
							<div class="card">
								...
								<?php if (isset($_GET["filter"])) : ?>
									<div class="row card-body">
										<div class="col-md-12">
											<h3>
												Agenda Surat Masuk dari tanggal <strong><?= tgl_indo(date($_GET["dari"])); ?></strong> sampai dengan tanggal <strong><?= tgl_indo(date($_GET["ke"])); ?></strong>

												<?php if (!empty($querySuratMasuk)) : ?>
													<a href="print-surat-masuk?dari=<?= $_GET["dari"]; ?>&ke=<?= $_GET["ke"]; ?>&filer=" class="btn btn-warning"><i class="fa fa-print"></i> CETAK</a>
												<?php endif; ?>
