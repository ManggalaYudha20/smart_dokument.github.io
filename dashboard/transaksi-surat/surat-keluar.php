...
// query table surat keluar
$querySuratKeluar = query("SELECT * FROM tb_surat_keluar");
...
<head>
	...
	<title>Surat Keluar - smart dokument</title>
...
<body>
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="../" class="logo text-white">
					<img src="../assets/img/Aldy.png?v=<?= time(); ?>" alt="Arsip smart dokument"width="70">
				</a>
								...
								<?php if ($rowSession["level"] === $levelSuperAdmin) :  ?>
									<div class="card-header">
										<div class="d-flex align-items-center">
											...
											<a href="add-surat-keluar" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i> Tambah Data</a>
										</div>
									</div>
								<?php endif; ?>
								<div class="card-body">
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover">
											...
											<tbody>
												<?php $noTable = 1; ?>
												<?php foreach ($querySuratKeluar as $row) : ?>
													<tr>
														<td><?= $noTable; ?></td>
														<td><?= $row["no_agenda"]; ?></td>
														...
														<td><?= $row["isi"]; ?></td>
														<td>
															<a href="../../uploads/surat-keluar/<?= $row["file"]; ?>" class="bg-info download-file" title="Download File"><i class="fa fa-download"></i></a>
														</td>
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		...
																		<?php endif; ?>
																		<?php if ($rowSession["level"] === $levelSuperAdmin) : ?>
																			<a class="dropdown-item text-light bg-primary" href="edit-surat-keluar?id_surat_keluar=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>

																			<a class="dropdown-item text-light bg-danger" href="#" data-toggle="modal" data-target="#delete-surat-keluar<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
																		<?php endif; ?>
																	</div>
																</div>
															</div>
		...
		<?php foreach ($querySuratKeluar as $row) : ?>
			<div class="modal fade" id="delete-surat-keluar<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus Surat Keluar?</h5>
						...
						<div class="modal-body">
							<table>
								...
								<tr>
									...
									<td>: <a href="../../uploads/surat-keluar/<?= $row["file"]; ?>"><i class="fa fa-download"></i> Download</a></td>
								</tr>
							</table>
						</div>
						<div class="modal-footer">
							<button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
							<a href="delete-surat-keluar?id_del_sk=<?= $row["id"]; ?>" type="button" class="btn btn-danger">Hapus</a>
						</div>
					</div>
				</div>
			</div>
