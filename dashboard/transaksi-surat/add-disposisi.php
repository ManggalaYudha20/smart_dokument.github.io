...
if (isset($_POST["disposisi"])) {
	if (tambahDataDisposisiSurat($_POST) > 0) {
		$id_surat_masuk = $_GET["id_surat_masuk"];
		echo "
    <script>
      alert('SUKSES! Data berhasil ditambahkan');
      document.location.href = 'disposisi-surat?id_surat_masuk=$id_surat_masuk';
    </script>";
	} else {
		echo "
    <script>
...
<head>
	...
	<title>Tambah Disposisi Surat - smart dokument</title>
		...
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="../" class="logo text-white">
					<img src="../assets/img/logo_bappeda_litbang_bonbol.png?v=<?= time(); ?>" alt="smart dokument">
				</a>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Tambah Data Disposisi Surat</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Tambah Data Disposisi Surat</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<form action="" method="post" class="user" enctype="multipart/form-data">
									<input type="hidden" name="id_user" value="<?= base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode($queryIdSuratMasuk["id_user"]))))))))); ?>">
									<input type="hidden" name="id_surat" value="<?= base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode($queryIdSuratMasuk["id"]))))))))); ?>">
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="tujuan_disposisi" name="tujuan_disposisi" type="text" class="form-control input-border-bottom" required="">
											<label for="tujuan_disposisi" class="placeholder"><img src="../../assets/img/flaticon/location.png?v=<?= time(); ?>" alt=""> Tujuan Disposisi</label>
										</div>

										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="isi_disposisi" name="isi_disposisi" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											...
											<input id="batas_waktu" name="batas_waktu" type="date" class="form-control input-border-bottom" required="">
										</div>
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="catatan" name="catatan" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="disposisi" class="btn btn-primary btn-addsm">SIMPAN <i class="fa fa-save"></i></button>
