...
if (isset($_POST["surat_keluar"])) {
	if (tambahDataSuratKeluar($_POST) > 0) {
		echo "
    <script>
...
$readNotificationSk = "1";
$readAllNotificationSk = "0";
...
<head>
	...
	<title>Tambah Surat Keluar - smart dokument</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Tambah Data Surat Keluar</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Tambah Data Surat Keluar</a>
							</li>
						</ul>
					</div>
					<div class="row">
						<div class="col-md-12">
							<div class="card">
								<form action="" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="tujuan_surat" name="tujuan_surat" type="text" class="form-control input-border-bottom" required="">
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="keterangan" name="keterangan" type="text" class="form-control input-border-bottom" required="">
									...
									<input type="text" hidden name="status_read" value="<?= base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode($readNotificationSk))))))))); ?>">
									<input type="text" hidden name="status_read_all" value="<?= base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode(base64_encode($readAllNotificationSk))))))))); ?>">
									...
									<input type="text" hidden name="notif" value="tsk">

									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="surat_keluar" class="btn btn-primary btn-addsm">SIMPAN <i class="fa fa-save"></i></button>
