...
// ====================================================
// PENGKONDISIAN KLASIFIKASI SURAT
// ====================================================
// TAMBAH DATA KLASIFIKASI SURAT
if (isset($_POST["klasifikasi"])) {
	if (tambahDataKlasifikasiSurat($_POST) > 0) {
		echo "
    <script>
      alert('SUKSES! Data berhasil ditambahkan');
      document.location.href = 'klasifikasi-surat';
    </script>";
	} else {
		echo "
    <script>
...
if ($rowSession["level"] !== $levelSuperAdmin) {
	header("Location:klasifikasi-surat");
	exit;
}
...
<head>
	...
	<title>Tambah Data Klasifikasi Surat - smart dokument</title>
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Tambah Data Klasifikasi Surat</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Tambah Data Klasifikasi Surat</a>
							</li>
						</ul>
					</div>
					<div class="row">
								...
								<form action="" method="post" class="user" enctype="multipart/form-data">
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="kode" name="kode" type="text" class="form-control input-border-bottom" required="">
											<label for="kode" class="placeholder"><img src="../../assets/img/flaticon/letter-a.png?v=<?= time(); ?>" alt=""> Kode</label>
										</div>

										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<input id="nama" name="nama" type="text" class="form-control input-border-bottom" required="">
											<label for="nama" class="placeholder"><img src="../../assets/img/flaticon/letter-t.png?v=<?= time(); ?>" alt=""> Nama</label>
										</div>
									</div>

									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-12 mb-3 mb-sm-0">
											<input id="uraian" name="uraian" type="text" class="form-control input-border-bottom" required="">
											<label for="uraian" class="placeholder"><img src="../../assets/img/flaticon/edit-info.png?v=<?= time(); ?>" alt=""> Uraian</label>
										</div>
									</div>
									...
									<div class="card-body row form-add">
										<div class="form-group form-floating-label col-sm-6 mb-3 mb-sm-0">
											<button type="submit" name="klasifikasi" class="btn btn-primary btn-addsm">SIMPAN <i class="fa fa-save"></i></button>
