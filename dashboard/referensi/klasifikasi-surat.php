...
// query table klasifikasi
$queryKlasifikasi = query("SELECT * FROM tb_klasifikasi");
...
<head>
	...
	<title>Data Klasifikasi Surat - smart dokument</title>
...
<body>
	<div class="wrapper">
			...
			<div class="content">
				<div class="page-inner">
					<div class="page-header">
						<h4 class="page-title">Data Klasifikasi Surat</h4>
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="#">Data Klasifikasi Surat</a>
							</li>
						</ul>
					</div>
					<div class="row">
								...
								<?php if ($rowSession["level"] === $levelSuperAdmin) : ?>
									<div class="card-header">
										<div class="d-flex align-items-center">
											...
											<a href="add-klasifikasi-surat" class="btn btn-primary btn-round ml-auto"><i class="fa fa-plus"></i> Tambah Data</a>
										</div>
									</div>
								<?php endif; ?>
								<div class="card-body">
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover">
											...
											<tbody>
												<?php $noTable = 1; ?>
												<?php foreach ($queryKlasifikasi as $row) : ?>
													<tr>
														<td><?= $noTable; ?></td>
														<td><?= $row["kode"]; ?></td>
														<td><?= $row["nama"]; ?></td>
															...
															<div class="form-button-action">
																<div class="dropdown show">
																	...
																	<div class="dropdown-menu dropdown-menu-opsi" aria-labelledby="dropdownMenuLink">
																		...
																		<?php endif; ?>
																		<?php if ($rowSession["level"] === $levelSuperAdmin) : ?>
																			<a class="dropdown-item text-light bg-primary" href="edit-klasifikasi-surat?id_klasifikasi=<?= $row["id"]; ?>"><i class="fa fa-edit"></i> Edit</a>

																			<a class="dropdown-item text-light bg-danger" href="#" data-toggle="modal" data-target="#delete-klasifikasi-surat<?= $row["id"]; ?>"><i class=" fa fa-trash"></i> Hapus</a>
																		<?php endif; ?>
																	</div>
																</div>
															</div>
		...
		<!-- Modal Delete Klasifikasi Surat-->
		<?php foreach ($queryKlasifikasi as $row) : ?>
			<div class="modal fade" id="delete-klasifikasi-surat<?= $row["id"]; ?>" tabindex=" -1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
				<div class="modal-dialog modal-dialog-centered" role="document">
					<div class="modal-content">
						<div class="modal-header">
							<h5 class="modal-title" id="exampleModalLongTitle">Hapus Klasifikasi Surat?</h5>
						...
						<div class="modal-footer">
							...
							<a href="delete-klasifikasi-surat?id_klasifikasi=<?= $row["id"]; ?>" type="button" class="btn btn-danger">Hapus</a>
						</div>
					</div>
				</div>
			</div>
